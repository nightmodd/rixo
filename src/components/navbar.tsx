        ...
        featured: [
            {
                title: 'Shope New In',
                path: '/collections/new-in',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/New_Collection_2_1.jpg?',
            },
            {
                title: 'Shop Exclusives',
                path: '/collections/exclusives',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Exclusives_1.jpg?',
            },
        ],
        sublinks: [
            {
        ...
        featured: [
            {
                ...
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Dresses_c1ef51b1-3cd1-4e1b-b24c-7a745b352e35.png?',
            },
        ],
        sublinks: [
            {
        ...
        featured: [
            {
                ...
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Dresses_2_1d20abce-2039-49cf-b116-934426b5942a.jpg?',
            },
            {
                title: 'Rixo Rental',
                path: '/collections/rexio-rental',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Rent_a_dress_2.png?',
            },
        ],
        sublinks: [
            {
        ...
        featured: [
            {
                title: 'New In',
                path: '/collections/new-in',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Dresses_5_1.jpg?',
            },
            {
                title: 'Rixo Rental',
                path: '/collections/rixo-rental',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Rent_a_Dress_1.jpg?',
            },
        ],
        sublinks: [
            {
        ...
        featured: [
            {
                title: 'Shop Dresses',
                path: '/collections/shop-dresses',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Dresses_4.jpg?',
            },
            {
                title: 'Shop Exclusives',
                path: '/collections/shop-exclusives',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Exclusives_2.jpg?',
            },
        ],
        sublinks: [
            {
        ...
        featured: [
            {
                ...
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Bags.jpg?',
            },
            {
                title: 'Shop Jewellery',
                path: '/collections/shop-jewellery',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Jewellery.jpg?',
            },
        ],
        sublinks: [
            {
        ...
        featured: [
            {
                ...
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Bridal_2_d96b6f68-2649-4049-ac3b-a365ac4c0e91.jpg?',
            },
            {
                title: 'Shop Bridesmaids',
                path: '/collections/shop-bridesmaids',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Bridesmaids_1.jpg?',
            },
            {
                title: 'Bridal Appointment',
                path: '/collections/bridal-appointment',
                image: 'https://cdn.shopify.com/s/files/1/0327/1609/5533/files/Bridal_Appts.png?',
            },
            {
                title: 'Bridal Appointment',
                path: '/collections/bridal-appointment',
...
const MainNavigation = () => {
    ...
    const featured = document.querySelectorAll(`.${styles.featured_item}`);
                                ...
                                {item.sublinks && (
                                    <>
                                        ...
                                        >
                                            <div
                                                className={
                                                    styles.desk_submenus_container
                                                }
                                            >
                                                {item.sublinks.map(
                                                    (subitem) => (
                                                            ...
                                                            if (counter < 4) {
                                                                ...
                                                                return (
                                                                    <Link
                                                                        ...
                                                                        className={
                                                                            styles.featured_item
                                                                        }
                                                                    >
                                                                        <div
                                                                            className={
                                                                                styles.featured_item_upper
                                                                            }
                                                                        >
                                                                            <img
                                                                                src={
